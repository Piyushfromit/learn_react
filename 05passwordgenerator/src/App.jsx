...
function App() {
  ...
  }, [length, numberAllowed, speCharAllowed, setPassword ])
  ...
  useEffect(() => {
    passwordGenerator()
  }, [length, numberAllowed, speCharAllowed, passwordGenerator])
  ...
  return (
    ...
    <div className="w-full max-w-xl mx-auto shadow-md rounded-lg px-4 py-3 my-8 bg-gray-800 text-orange-500"> 
        ...
        <div className='flex text-sm gap-x-2'>
          ...
          <div className='flex items-center gap-x-1'> 
            <input type="checkbox" defaultChecked={speCharAllowed} id="characterInput" 
               onChange={() => {
                  setSpeCharAllowed((prev) => !prev);
               }}
            />
